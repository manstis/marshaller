...
public interface ClusteringModel {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the clusteringField property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    List<ClusteringField> getClusteringField();
     ...
     *     
     */
    void setMissingValueWeights(MissingValueWeights value);
     ...
     *     
     */
    BigInteger getNumberOfClusters();
     ...
     *     
     */
    void setNumberOfClusters(BigInteger value);
