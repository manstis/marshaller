...
public class Taxonomy
    implements com.anstis.pmml.model.api.Taxonomy
{

    @XmlElement(name = "Extension", type = Extension.class)
    protected List<com.anstis.pmml.model.api.Extension> extension;
    @XmlElement(name = "ChildParent", required = true, type = ChildParent.class)
    protected List<com.anstis.pmml.model.api.ChildParent> childParent;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.ChildParent> getChildParent() {
        if (childParent == null) {
            childParent = new ArrayList<com.anstis.pmml.model.api.ChildParent>();
        }
