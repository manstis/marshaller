...
public class Targets
    implements com.anstis.pmml.model.api.Targets
{
    ...
    protected List<com.anstis.pmml.model.api.Target> target;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.Target> getTarget() {
        if (target == null) {
            target = new ArrayList<com.anstis.pmml.model.api.Target>();
        }
        return this.target;
    }
