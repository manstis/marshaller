 ...
 *         &lt;element ref="{http://www.dmg.org/PMML-4_4}OutputField" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@GWT3Export
public class Output
    implements com.anstis.pmml.model.api.Output
{

    @XmlElement(name = "Extension", type = Extension.class)
    protected List<com.anstis.pmml.model.api.Extension> extension;
    @XmlElement(name = "OutputField", required = true, type = OutputField.class)
    protected List<com.anstis.pmml.model.api.OutputField> outputField;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.OutputField> getOutputField() {
        if (outputField == null) {
            outputField = new ArrayList<com.anstis.pmml.model.api.OutputField>();
        }
