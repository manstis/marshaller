...
public class Sequence {
    ...
    @XmlElementRefs({
            @XmlElementRef(name = "Extension", type = Extension.class),
            @XmlElementRef(name = "Delimiter", type = Delimiter.class),
            @XmlElementRef(name = "Time", type = Time.class),
            @XmlElementRef(name = "SetReference", type = SetReference.class)
    })
