 ...
 *         &lt;element ref="{http://www.dmg.org/PMML-4_4}DefineFunction" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class TransformationDictionary
    implements com.anstis.pmml.model.api.TransformationDictionary
{

    @XmlElement(name = "Extension", type = Extension.class)
    protected List<com.anstis.pmml.model.api.Extension> extension;
    @XmlElement(name = "DefineFunction", type = DefineFunction.class)
    protected List<com.anstis.pmml.model.api.DefineFunction> defineFunction;
    @XmlElement(name = "DerivedField", type = DerivedField.class)
    protected List<com.anstis.pmml.model.api.DerivedField> derivedField;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.DefineFunction> getDefineFunction() {
        if (defineFunction == null) {
            defineFunction = new ArrayList<com.anstis.pmml.model.api.DefineFunction>();
        }
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.DerivedField> getDerivedField() {
        if (derivedField == null) {
            derivedField = new ArrayList<com.anstis.pmml.model.api.DerivedField>();
        }
