...
public class PMML
    implements com.anstis.pmml.model.api.PMML
{

    @XmlElement(name = "Header", required = true, type = Header.class)
    protected com.anstis.pmml.model.api.Header header;
    @XmlElement(name = "MiningBuildTask", type = MiningBuildTask.class)
    protected com.anstis.pmml.model.api.MiningBuildTask miningBuildTask;
    @XmlElement(name = "DataDictionary", required = true, type = DataDictionary.class)
    protected com.anstis.pmml.model.api.DataDictionary dataDictionary;
    @XmlElement(name = "TransformationDictionary", type = TransformationDictionary.class)
    protected com.anstis.pmml.model.api.TransformationDictionary transformationDictionary;
    @XmlElementRefs({
     ...
     *
     */
    public com.anstis.pmml.model.api.Header getHeader() {
        return header;
    }
     ...
     *
     */
    public void setHeader(com.anstis.pmml.model.api.Header value) {
        this.header = value;
    }
     ...
     *
     */
    public com.anstis.pmml.model.api.MiningBuildTask getMiningBuildTask() {
     ...
     *
     */
    public void setMiningBuildTask(com.anstis.pmml.model.api.MiningBuildTask value) {
     ...
     *
     */
    public com.anstis.pmml.model.api.DataDictionary getDataDictionary() {
     ...
     *
     */
    public void setDataDictionary(com.anstis.pmml.model.api.DataDictionary value) {
     ...
     *
     */
    public com.anstis.pmml.model.api.TransformationDictionary getTransformationDictionary() {
     ...
     *
     */
    public void setTransformationDictionary(com.anstis.pmml.model.api.TransformationDictionary value) {
