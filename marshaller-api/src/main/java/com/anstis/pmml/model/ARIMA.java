...
public class ARIMA {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dynamicRegressor property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the outlierEffect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
