...
public class ModelStats
    implements com.anstis.pmml.model.api.ModelStats
{

    @XmlElement(name = "Extension", type = Extension.class)
    protected List<com.anstis.pmml.model.api.Extension> extension;
    @XmlElement(name = "UnivariateStats", type = UnivariateStats.class)
    protected List<com.anstis.pmml.model.api.UnivariateStats> univariateStats;
    @XmlElement(name = "MultivariateStats", type = MultivariateStats.class)
    protected List<com.anstis.pmml.model.api.MultivariateStats> multivariateStats;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.UnivariateStats> getUnivariateStats() {
        if (univariateStats == null) {
            univariateStats = new ArrayList<com.anstis.pmml.model.api.UnivariateStats>();
        }
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.MultivariateStats> getMultivariateStats() {
        if (multivariateStats == null) {
            multivariateStats = new ArrayList<com.anstis.pmml.model.api.MultivariateStats>();
        }
