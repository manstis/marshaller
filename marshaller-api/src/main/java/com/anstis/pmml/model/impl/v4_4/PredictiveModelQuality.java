...
public class PredictiveModelQuality
    implements IModelExplanation, com.anstis.pmml.model.api.PredictiveModelQuality
{
    ...
    protected com.anstis.pmml.model.api.ConfusionMatrix confusionMatrix;
    @XmlElement(name = "LiftData", type = LiftData.class)
    protected List<com.anstis.pmml.model.api.LiftData> liftData;
    @XmlElement(name = "ROC", type = ROC.class)
    protected com.anstis.pmml.model.api.ROC roc;
     ...
     *
     */
    public com.anstis.pmml.model.api.ConfusionMatrix getConfusionMatrix() {
     ...
     *
     */
    public void setConfusionMatrix(com.anstis.pmml.model.api.ConfusionMatrix value) {
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.LiftData> getLiftData() {
        if (liftData == null) {
            liftData = new ArrayList<com.anstis.pmml.model.api.LiftData>();
        }
     ...
     *     
     */
    public com.anstis.pmml.model.api.ROC getROC() {
        return roc;
    }
     ...
     *     
     */
    public void setROC(com.anstis.pmml.model.api.ROC value) {
        this.roc = value;
    }
