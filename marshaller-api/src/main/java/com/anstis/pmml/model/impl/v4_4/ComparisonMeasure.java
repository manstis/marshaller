...
import com.anstis.pmml.model.api.IMeasure;
...
public class ComparisonMeasure {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "euclidean", namespace = "http://www.dmg.org/PMML-4_4", type = Euclidean.class, required = false),
        @XmlElementRef(name = "squaredEuclidean", namespace = "http://www.dmg.org/PMML-4_4", type = SquaredEuclidean.class, required = false),
        @XmlElementRef(name = "chebychev", namespace = "http://www.dmg.org/PMML-4_4", type = Chebychev.class, required = false),
        @XmlElementRef(name = "cityBlock", namespace = "http://www.dmg.org/PMML-4_4", type = CityBlock.class, required = false),
        @XmlElementRef(name = "minkowski", namespace = "http://www.dmg.org/PMML-4_4", type = Minkowski.class, required = false),
        @XmlElementRef(name = "simpleMatching", namespace = "http://www.dmg.org/PMML-4_4", type = SimpleMatching.class, required = false),
        @XmlElementRef(name = "jaccard", namespace = "http://www.dmg.org/PMML-4_4", type = Jaccard.class, required = false),
        @XmlElementRef(name = "tanimoto", namespace = "http://www.dmg.org/PMML-4_4", type = Tanimoto.class, required = false),
        @XmlElementRef(name = "binarySimilarity", namespace = "http://www.dmg.org/PMML-4_4", type = BinarySimilarity.class, required = false)
    })
