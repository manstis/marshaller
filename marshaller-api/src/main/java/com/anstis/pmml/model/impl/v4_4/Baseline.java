...
public class Baseline {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "CountTable", namespace = "http://www.dmg.org/PMML-4_4", type = CountTable.class, required = false),
        @XmlElementRef(name = "NormalizedCountTable", namespace = "http://www.dmg.org/PMML-4_4", type = NormalizedCountTable.class, required = false),
