...
@GWT3Export
public class Apply
    implements com.anstis.pmml.model.api.Apply, com.anstis.pmml.model.api.IExpression
{
    ...
    protected List<com.anstis.pmml.model.api.IExpression> expression;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.IExpression> getExpression() {
        if (expression == null) {
            expression = new ArrayList<com.anstis.pmml.model.api.IExpression>();
        }
