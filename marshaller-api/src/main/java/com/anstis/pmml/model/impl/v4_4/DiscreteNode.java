...
import com.anstis.pmml.model.api.IProbability;
    ...
    implements IBayesianNode
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "DiscreteConditionalProbability", namespace = "http://www.dmg.org/PMML-4_4", type = DiscreteConditionalProbability.class, required = false),
        @XmlElementRef(name = "ValueProbability", namespace = "http://www.dmg.org/PMML-4_4", type = ValueProbability.class, required = false)
    })
