...
import com.anstis.pmml.model.api.IBayesInput;
...
@XmlType(name = "", propOrder = {
    "extension",
    "targetValueStatsOrDerivedFieldAndPairCounts"
})
...
public class BayesInput {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "TargetValueStats", namespace = "http://www.dmg.org/PMML-4_4", type = TargetValueStats.class, required = false),
        @XmlElementRef(name = "DerivedField", namespace = "http://www.dmg.org/PMML-4_4", type = DerivedField.class, required = false),
        @XmlElementRef(name = "PairCounts", namespace = "http://www.dmg.org/PMML-4_4", type = PairCounts.class, required = false)
    })
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the targetValueStatsOrDerivedFieldAndPairCounts property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
