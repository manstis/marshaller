...
import com.anstis.pmml.model.api.IMatrix;
...
@GWT3Export
public class Matrix
    implements com.anstis.pmml.model.api.Matrix
{

    @XmlElementRefs({
        @XmlElementRef(name = "NUM-ARRAY", namespace = "http://www.dmg.org/PMML-4_4", type = NUMARRAY.class, required = false),
        @XmlElementRef(name = "MatCell", namespace = "http://www.dmg.org/PMML-4_4", type = MatCell.class, required = false)
    })
