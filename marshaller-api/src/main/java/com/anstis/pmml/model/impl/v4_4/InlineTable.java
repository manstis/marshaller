 ...
 *         &lt;element ref="{http://www.dmg.org/PMML-4_4}row" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class InlineTable
    implements ITable, com.anstis.pmml.model.api.InlineTable
{

    @XmlElement(name = "Extension", type = Extension.class)
    protected List<com.anstis.pmml.model.api.Extension> extension;
    @XmlElement(type = Row.class)
    protected List<com.anstis.pmml.model.api.Row> row;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.Row> getRow() {
        if (row == null) {
            row = new ArrayList<com.anstis.pmml.model.api.Row>();
        }
        return this.row;
    }
