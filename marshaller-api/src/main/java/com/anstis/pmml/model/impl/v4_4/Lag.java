...
@GWT3Export
public class Lag
    implements IExpression, com.anstis.pmml.model.api.Lag
{
    ...
    protected List<com.anstis.pmml.model.api.BlockIndicator> blockIndicator;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.BlockIndicator> getBlockIndicator() {
        if (blockIndicator == null) {
            blockIndicator = new ArrayList<com.anstis.pmml.model.api.BlockIndicator>();
        }
