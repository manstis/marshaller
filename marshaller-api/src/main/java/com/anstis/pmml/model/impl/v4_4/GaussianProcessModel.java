...
import com.anstis.pmml.model.api.IKernel;
    ...
    implements IModel
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "RadialBasisKernel", namespace = "http://www.dmg.org/PMML-4_4", type = RadialBasisKernel.class, required = false),
        @XmlElementRef(name = "ARDSquaredExponentialKernel", namespace = "http://www.dmg.org/PMML-4_4", type = ARDSquaredExponentialKernel.class, required = false),
        @XmlElementRef(name = "AbsoluteExponentialKernel", namespace = "http://www.dmg.org/PMML-4_4", type = AbsoluteExponentialKernel.class, required = false),
        @XmlElementRef(name = "GeneralizedExponentialKernel", namespace = "http://www.dmg.org/PMML-4_4", type = GeneralizedExponentialKernel.class, required = false)
    })
