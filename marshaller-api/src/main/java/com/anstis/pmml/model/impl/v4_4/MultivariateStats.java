...
public class MultivariateStats
    implements com.anstis.pmml.model.api.MultivariateStats
{
    ...
    protected List<com.anstis.pmml.model.api.MultivariateStat> multivariateStat;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.MultivariateStat> getMultivariateStat() {
        if (multivariateStat == null) {
            multivariateStat = new ArrayList<com.anstis.pmml.model.api.MultivariateStat>();
        }
