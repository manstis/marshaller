...
public class DiscreteNode implements IBayesianNetworkNodes {
    ...
    @XmlElementRefs({
            @XmlElementRef(name = "DiscreteConditionalProbability", type = DiscreteConditionalProbability.class),
            @XmlElementRef(name = "ValueProbability", type = ValueProbability.class)
    })
