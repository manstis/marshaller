...
public class MaximumLikelihoodStat {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "KalmanState", namespace = "http://www.dmg.org/PMML-4_4", type = KalmanState.class, required = false),
        @XmlElementRef(name = "ThetaRecursionState", namespace = "http://www.dmg.org/PMML-4_4", type = ThetaRecursionState.class, required = false)
    })
