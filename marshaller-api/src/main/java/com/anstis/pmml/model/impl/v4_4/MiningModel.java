...
import com.anstis.pmml.model.api.IMiningModel;
 ...
 *           &lt;element ref="{http://www.dmg.org/PMML-4_4}Regression"/&gt;
 *           &lt;element ref="{http://www.dmg.org/PMML-4_4}DecisionTree"/&gt;
 *         &lt;/choice&gt;
 *         &lt;element ref="{http://www.dmg.org/PMML-4_4}Segmentation" minOccurs="0"/&gt;
    ...
    implements IModel
{
    ...
    protected List<IMiningModel> regressionOrDecisionTree;
    ...
    /**
     * Gets the value of the regressionOrDecisionTree property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the regressionOrDecisionTree property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRegressionOrDecisionTree().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<IMiningModel> getRegressionOrDecisionTree() {
        if (regressionOrDecisionTree == null) {
            regressionOrDecisionTree = new ArrayList<IMiningModel>();
        }
        return this.regressionOrDecisionTree;
    }
