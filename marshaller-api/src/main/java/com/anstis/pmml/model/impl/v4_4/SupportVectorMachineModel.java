...
import com.anstis.pmml.model.api.ISupportVectorMachineModel;
    ...
    implements IModel
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "LinearKernelType", namespace = "http://www.dmg.org/PMML-4_4", type = LinearKernelType.class, required = false),
        @XmlElementRef(name = "PolynomialKernelType", namespace = "http://www.dmg.org/PMML-4_4", type = PolynomialKernelType.class, required = false),
        @XmlElementRef(name = "RadialBasisKernelType", namespace = "http://www.dmg.org/PMML-4_4", type = RadialBasisKernelType.class, required = false),
        @XmlElementRef(name = "SigmoidKernelType", namespace = "http://www.dmg.org/PMML-4_4", type = SigmoidKernelType.class, required = false)
    })
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the supportVectorMachine property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
