...
public class MiningSchema
    implements com.anstis.pmml.model.api.MiningSchema
{
    ...
    protected List<com.anstis.pmml.model.api.MiningField> miningField;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.MiningField> getMiningField() {
        if (miningField == null) {
            miningField = new ArrayList<com.anstis.pmml.model.api.MiningField>();
        }
