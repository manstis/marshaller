...
@GWT3Export
public class Anova
    implements com.anstis.pmml.model.api.Anova
{
    ...
    protected List<com.anstis.pmml.model.api.AnovaRow> anovaRow;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.AnovaRow> getAnovaRow() {
        if (anovaRow == null) {
            anovaRow = new ArrayList<com.anstis.pmml.model.api.AnovaRow>();
        }
