...
public class BayesianNetworkNodes {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "DiscreteNode", namespace = "http://www.dmg.org/PMML-4_4", type = DiscreteNode.class, required = false),
        @XmlElementRef(name = "ContinuousNode", namespace = "http://www.dmg.org/PMML-4_4", type = ContinuousNode.class, required = false)
    })
    protected List<IBayesianNetworkNodes> discreteNodeOrContinuousNode;
     ...
     * 
     */
    public List<IBayesianNetworkNodes> getDiscreteNodeOrContinuousNode() {
        if (discreteNodeOrContinuousNode == null) {
            discreteNodeOrContinuousNode = new ArrayList<IBayesianNetworkNodes>();
        }
