...
public class Apply implements IApply {
    ...
    @XmlElementRefs({
            @XmlElementRef(name = "Constant", type = Constant.class),
            @XmlElementRef(name = "FieldRef", type = FieldRef.class),
            @XmlElementRef(name = "NormContinuous", type = NormContinuous.class),
            @XmlElementRef(name = "NormDiscrete", type = NormDiscrete.class),
            @XmlElementRef(name = "Discretize", type = Discretize.class),
            @XmlElementRef(name = "MapValues", type = MapValues.class),
            @XmlElementRef(name = "TextIndex", type = TextIndex.class),
            @XmlElementRef(name = "Apply", type = Apply.class),
            @XmlElementRef(name = "Aggregate", type = Aggregate.class),
            @XmlElementRef(name = "Lag", type = Lag.class)
    })
