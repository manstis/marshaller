 ...
 *         &lt;element ref="{http://www.dmg.org/PMML-4_4}Characteristic" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Characteristics
    implements com.anstis.pmml.model.api.Characteristics
{

    @XmlElement(name = "Extension", type = Extension.class)
    protected List<com.anstis.pmml.model.api.Extension> extension;
    @XmlElement(name = "Characteristic", required = true, type = Characteristic.class)
    protected List<com.anstis.pmml.model.api.Characteristic> characteristic;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.Characteristic> getCharacteristic() {
        if (characteristic == null) {
            characteristic = new ArrayList<com.anstis.pmml.model.api.Characteristic>();
        }
