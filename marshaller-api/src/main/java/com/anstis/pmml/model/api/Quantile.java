 ...
 *       &lt;/sequence&gt;
 *       &lt;attribute name="quantileLimit" use="required" type="{http://www.dmg.org/PMML-4_4}PERCENTAGE-NUMBER" /&gt;
 *       &lt;attribute name="quantileValue" use="required" type="{http://www.dmg.org/PMML-4_4}NUMBER" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public interface Quantile {
     ...
     * 
     */
    double getQuantileLimit();

    /**
     * Sets the value of the quantileLimit property.
     * 
     */
    void setQuantileLimit(double value);
     ...
     * 
     */
    void setQuantileValue(double value);
