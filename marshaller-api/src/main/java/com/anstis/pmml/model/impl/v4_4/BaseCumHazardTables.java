...
import com.anstis.pmml.model.api.IBaseline;
...
public class BaseCumHazardTables {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "BaselineStratum", namespace = "http://www.dmg.org/PMML-4_4", type = BaselineStratum.class, required = false),
        @XmlElementRef(name = "BaselineCell", namespace = "http://www.dmg.org/PMML-4_4", type = BaselineCell.class, required = false)
    })
