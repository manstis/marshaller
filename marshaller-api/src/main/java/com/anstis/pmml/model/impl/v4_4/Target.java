...
@GWT3Export
public class Target
    implements com.anstis.pmml.model.api.Target
{
    ...
    protected List<com.anstis.pmml.model.api.TargetValue> targetValue;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.TargetValue> getTargetValue() {
        if (targetValue == null) {
            targetValue = new ArrayList<com.anstis.pmml.model.api.TargetValue>();
        }
