 ...
 *         &lt;element ref="{http://www.dmg.org/PMML-4_4}NUM-ARRAY"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class BoundaryValueMeans
    implements com.anstis.pmml.model.api.BoundaryValueMeans
{

    @XmlElement(name = "Extension", type = Extension.class)
    protected List<com.anstis.pmml.model.api.Extension> extension;
    @XmlElement(name = "NUM-ARRAY", required = true, type = NUMARRAY.class)
    protected com.anstis.pmml.model.api.NUMARRAY numarray;
     ...
     *
     */
    public com.anstis.pmml.model.api.NUMARRAY getNUMARRAY() {
        return numarray;
    }
     ...
     *     
     */
    public void setNUMARRAY(com.anstis.pmml.model.api.NUMARRAY value) {
        this.numarray = value;
    }
