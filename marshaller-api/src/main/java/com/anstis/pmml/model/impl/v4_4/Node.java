...
@GWT3Export
public class Node
    implements com.anstis.pmml.model.api.INode
{
    ...
    protected List<com.anstis.pmml.model.api.INode> node;
     ...
     * 
     */
    public List<com.anstis.pmml.model.api.INode> getNode() {
        if (node == null) {
            node = new ArrayList<com.anstis.pmml.model.api.INode>();
        }
        return this.node;
    }
